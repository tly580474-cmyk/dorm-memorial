...
项目最低 Go 版本为 **1.26.7**，避免旧标准库的已知安全问题。完整竞态与依赖安全检查可运行 `./check-project.ps1 -Race -Security`（安全扫描需要联网，Windows 竞态检测需要 C 编译器）。本轮排查范围、修复及验证边界见 [`项目审查记录`](./docs/PROJECT_AUDIT_2026-08-30.md)。
